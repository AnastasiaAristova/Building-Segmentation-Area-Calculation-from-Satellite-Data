...
import torch
from backbone1 import UNet, check_img_size, make_prediction
...
checkpoints = torch.load(Path('/content/gdrive/MyDrive/final project dls/best_iou.pt'), map_location=DEVICE)
